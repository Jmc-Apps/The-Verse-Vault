...
function save(){ ensureStarterCollection(); data.version='1.25'; data.collections=data.collections||[]; localStorage.setItem(LS_ADMIN_DATA, JSON.stringify(data)); render(); }
function bind(){
...
async function saveGithubJson(){
  ...
  try{
    ...
    const body = {
      message: `Update Verse Vault verses.json from Admin v1.25`,
